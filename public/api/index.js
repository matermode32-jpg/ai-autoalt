...
app.post('/api/fix-alt', async (req, res) => {
  // Safely get shopDomain – if req.body is missing, fallback to env
  const shopDomain = (req.body && req.body.shop) || process.env.SHOPIFY_SHOP_DOMAIN;
...
// Start server when run directly (not as a module)
